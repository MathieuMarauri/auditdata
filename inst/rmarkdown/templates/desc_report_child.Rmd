...
```{r describe_{{i}}}
x <- data${{i}}
description <- describe(x, numeric_cutoff = numeric_cutoff, max_length = max_length, nchar = nchar, plot = FALSE)
```
...
```{r desc_{{i}}_plot, , fig.align = 'center', dpi = 300, out.width = '100%', fig.height = 4, fig.width = 10}
if (is_date(x)) {
